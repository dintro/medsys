...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Отделения', 'url'=>array('/admin/deps')),
                array('label'=>'Сотрудники', 'url'=>array('/admin/staff')),
                array('label'=>'Пользователи', 'url'=>array('/admin/user')),
                array('label'=>'Мед.журнал', 'url'=>array('/admin/mednotes')),
                array('label'=>'Стационар', 'url'=>array('/admin/hospital')),
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Dmitry Cherkasov.<br/>
